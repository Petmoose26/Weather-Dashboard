...
function getWeather(cityName) {
  ...
  $.ajax({
    ...
    $("#today").append(
      $("<h3>").text(titleCase(cityName) + " (" + todaysDate + ")")
    );
    $("#today").append(todayIcon);
    $("#today").append(
      $("<p>").text("Temperature: " + toFahrenheit(forecast.main.temp) + "°F")
    );
    $("#today").append(
      $("<p>").text("Humidity: " + forecast.main.humidity + "%")
    );
    $("#today").append(
      $("<p>").text("Wind Speed: " + forecast.wind.speed + " MPH")
    );
    ...
    for (i = 0; i < days.length; i++) {
      ...
      dayBox.append(
        $("<p>").text("Humidity: " + fiveDayForecast.main.humidity + "%")
      );
      dayBox.append(
        $("<p>").text("Temp: " + toFahrenheit(fiveDayForecast.main.temp) + "°F")
      );
    }
  });
}
